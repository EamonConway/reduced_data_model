...
#   } else {
#     windows<- c(0,cumsum(sample(1:5,80,replace = TRUE)))
#   }
#   windows <- windows[which(windows < 100)]
#   # for(filter_size in c(1)){
#
# filter_size = 1
#     # Real Data
...
#     figure1
#
#     figure1<-ggplot(aggregated_data, aes(x = week)) +
#       # geom_ribbon(data = I_plot_data, aes(ymin = mid_lower,ymax = mid_upper),alpha = 0.9,fill = "#7570b3") +
#       # geom_ribbon(data = I_plot_data, aes(ymin = lower,ymax = upper),alpha = 0.5,fill = "#7570b3") +
#       geom_col(aes(y = WeeklyIncidence))  +
#       scale_y_continuous("Reported Incidence")+
#       scale_x_date("Day") +
#       theme_classic() +
#       theme(text = element_text(size=16))
#     if(length(xmax)!=0){
...
#     }
#     figure1
#     ggsave(paste0("final_pictures/RealData/ReportedData", window_size, "Filter",filter_size,"Area", Area, ".svg"),plot = figure1,, width = 89,height = 60,units="mm",dpi=300,create.dir = TRUE)
...
#       # geom_vline(xintercept = aggregated_data$week-1,linetype="dotted") +
#       # geom_point(aes(y = cases),size = 0.6)  +
#       geom_col(aes(y = cases),alpha =0.3) +
#       scale_y_continuous("Daily Incidence")+
#       scale_x_date("Day") +
#       theme_classic() +
#       theme(text = element_text(size=16))
...
#     }
#     figure1
#     ggsave(paste0("final_pictures/RealData/ColIncidenceWindow", window_size, "Filter",filter_size,"Area", Area, ".svg"),plot = figure1,, width = 89,height = 60,units="mm",dpi=300,create.dir = TRUE)
#
